...
namespace backend
{
    ...
    */
    ...
    protected:
        ...
        VecX residual_;                 // 残差
        std::vector<MatXX> jacobians_;  // 雅克比, 每个雅克比维度是 residual × vertex[i]
    ...
    public:
        ...
        // 设置一个顶点, 参数vertex为 对应的vertex对象
        bool AddVertex(std::shared_ptr<Vertex> vertex)
        {
            verticies_.emplace_back(vertex);    //在vector的结尾插入一个新的元素，位置为当前最后一个元素的右边
            return true;
        }

        // 设置一个顶点 vertices 顶点, 按引用顺序排列
        ...
        void SetInformation(const MatXX &information)
        {
            ...
            // sqrt information  https://blog.csdn.net/hanshihao1336295654/article/details/83422496
