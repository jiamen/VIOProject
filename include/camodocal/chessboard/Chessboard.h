...
#ifndef _JMVIO_CHESSBOARD_H_
#define _JMVIO_CHESSBOARD_H_
...
private:
    ...
    bool findChessboardCorners( const cv::Mat& image,
                                ...
                                int flags, bool useOPenCV);         // 确定用哪个findChessboardCorners函数找角点,OpenCV自带函数或者自己写的
