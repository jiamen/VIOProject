...
#ifndef INC_03_MYCURVEFITTING_LM_EIGEN_TYPES_H
#define INC_03_MYCURVEFITTING_LM_EIGEN_TYPES_H
...
// double matricies(matrix复数) double型矩阵
...
#endif //INC_03_MYCURVEFITTING_LM_EIGEN_TYPES_H
